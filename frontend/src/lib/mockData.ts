...
export const mockSpaces: Space[] = [
  ...
  },
  {
    ...
    type: "sport",
    description:
      "Professional pickle ball courts with premium surface and tournament-grade equipment. Perfect for both beginners and advanced players.",
  ...
  {
    id: "8",
    name: "Elite Pickle Ball Center",
    type: "sport",
    description:
      "Indoor pickle ball facility with climate control and multiple courts. Ideal for year-round play and tournaments.",
    images: ["/placeholder-pickleball-indoor.jpg"],
    location: {
    ...
    rating: 4.7,
    reviews: 92,
    availability: generateTimeSlots(65),
  },
];
